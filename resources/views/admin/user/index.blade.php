                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <th><a class="btn btn-danger btn-sm"
                                                onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data User? Menghapus Kategori Dapat Menghapus Seluruh Data Yang Berelasi')"
                                                href="{{ route('user.destroy', 1) }}">
