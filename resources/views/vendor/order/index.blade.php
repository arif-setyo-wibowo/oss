                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Rrder</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                ...
                                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="custom-tab-kategori" data-toggle="pill"
                                            ...
                                            aria-selected="true">Data Order</a>
                                    </li>
                                </ul>
                                            ...
                                            <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data order?')"
                                                            href="">
